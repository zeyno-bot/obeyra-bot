...
let handler = async (m, { conn, usedPrefix: _p, command, args, isOwner, isAdmin }) => {
  ...
  const securityFeatures = [
    { key: 'antigore', name: '🚫 𝖠𝗇𝗍𝗂_𝗀𝗈𝗋𝖾', desc: 'Blocca contenuti splatter/gore' },
    ...
    { key: 'antilinksocial', name: '🌐 𝖢𝖻_𝖫𝗂𝗇𝗄_𝖲𝗈𝖼𝗂𝖺𝗅', desc: 'Elimina link social' },
  ...
  const automationFeatures = [
    ...
    { key: 'vocali', name: '🎤 𝖵𝗈𝖼𝖾_𝖲𝗒𝘚', desc: 'Risponde con audio ai messaggi' },
  ...
  const ownerFeatures = [
    { key: 'anticall', name: '📵 𝖠𝗇𝗍𝗂_𝖢𝖺𝗅𝗅', desc: 'Blocca chiamate al bot' },
...
_𝘚𝘺𝘴𝘵𝘦𝘮 𝘸𝘪𝘭𝘭 𝘯𝘰𝘵 𝘳𝘦𝘉𝘰𝘰𝘵. 𝘌𝘯𝘫𝘰𝘺 𝘵𝘩𝘦 𝘤𝘩𝘢𝘰𝘴._`
